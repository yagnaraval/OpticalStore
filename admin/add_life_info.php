                            ...
                            <div class=" form">
                                <form class="cmxform form-horizontal " id="commentForm" method="post"  novalidate="novalidate">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="lifename" minlength="2" type="text" required="">
                                        </div>
                                    </div>
...
if(isset($_REQUEST['savecat']))
{
	$id=$_SESSION['AdminID'];
	extract($_REQUEST);
	$n=iud("INSERT INTO `life_info`( `Name`) VALUES ('$lifename') ");
	if($n==1)
	{
echo "Successful";
	}
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>© 2019 ADMIN. All rights reserved | Design by Anshu Baghel</p>
			</div>
		  </div>
  <!-- / footer -->
</section>
