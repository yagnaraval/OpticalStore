                            ...
                            <div class=" form">
                                <form class="cmxform form-horizontal" enctype="multipart/form-data" id="commentForm" method="post"  novalidate="novalidate">
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">Problem  Name : </label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="Pro_name"  type="text" required="">
                                        </div>
                                    </div>
									...
									<div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">Charge :</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="charge"  type="text" required="">
                                        </div>
                                    </div>
...
if(isset($_REQUEST['savecat']))
{
	...
	$n=iud("INSERT INTO `problem`( `name`, `charge`) VALUES('$Pro_name','$charge') ");
	if($n==1)
	{
echo "Successful";
	}
