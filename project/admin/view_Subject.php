 ...
 <div class="panel panel-default">
    ...
    <div>
      <table class="table" ui-jq="footable" ui-options='{
		...
		<?php
		$n=1;
		$result=select("SELECT * FROM `subject` WHERE status='1' ");
		...
		?>
          <tr data-expanded="true">
            <td><?=$n;?></td>
            <td><?=ucwords($SubjectName)?></td>
            <td><a href="edit_Subject.php?id=<?=$r['SubjectID']?>"><button class="btn btn-success">Edit</button></td>
            <td><a href="delete_Subject.php?id=<?=$r['SubjectID']?>"><button class="btn btn-danger">Delete</button></td>
